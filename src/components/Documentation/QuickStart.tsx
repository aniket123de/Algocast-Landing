  ...
  return (
    <div className='pb-10 md:scroll-m-[180px] scroll-m-28' id='start'>
      ...
      <div className='p-6 rounded-md border mt-6 border-border'>
        ...
        <p className='text-base font-medium text-[#0A1B3F]'>
        ...
        <ul className='list-disc text-[#0A1B3F] ps-6'>
          <li>node js 20+</li>
          <li>npm js 10+</li>
        </ul>
      </div>
      <div className='p-6 rounded-md border mt-6 border-border'>
        ...
        <p className='text-base font-medium text-[#0A1B3F] mb-4'>
      ...
      <div className='p-6 rounded-md border mt-6 border-border'>
        ...
        <p className='text-base font-medium text-[#0A1B3F] my-4'>
      ...
      <div className='p-6 rounded-md border mt-6 border-border'>
        ...
        <p className='text-base font-medium text-[#0A1B3F] mt-6'>

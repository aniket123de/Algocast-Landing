    ...
    <div id='structure' className='md:scroll-m-[130px] scroll-m-28'>
      ...
      <div className='rounded-md p-6 pt-3 border border-border mt-6'>
        <div className='flex items-center gap-4'>
          <h5 className='text-base font-medium text-[#0A1B3F] mt-3 mb-1'>
        ...
        <ul className='ps-0 md:ps-5 list-unstyled'>
          <li className='py-2'>
            <div className='flex items-center gap-3'>
              ...
              <span className='font-medium text-[#0A1B3F]'>
                <Icon
                  icon='tabler:folder'
                                  ...
                                  <ul className='ps-5 md:ps-12 list-unstyled red'>
                                    <li className='py-2'>
                                      <div className='flex items-center gap-3'>
                                        ...
                                        <span className='fs-9 text-[#0A1B3F] ms-4'>
                                          ...
                                          <li className='py-2'>
                                            <div className='flex items-center gap-8'>
                                              ...
                                              <div className='flex items-center gap-3'>
                                                ...
                                                <span className='font-medium text-[#0A1B3F] flex items-center flex-wrap'>
                                                  <Icon
                                                    icon='tabler:folder'
                                                    className='text-primary text-base inline-block me-2'
                                                  />

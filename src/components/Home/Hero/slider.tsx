  ...
  return (
    <div className="pt-14 flex flex-col gap-10">
      <div className="flex flex-col gap-3 items-center justify-center text-center">
        ...
        <h2 className="sm:text-5xl text-3xl text-foreground font-medium">
      ...
      <Slider {...settings}>
        {pricedeta.map((item, index) => (
          <div key={index} className="pr-6">
            <Card className="bg-foreground/5 border-none shadow-none rounded-xl p-0">
              <CardContent className="px-5 py-6">
                ...
                <div className="flex justify-center mt-2">
                  <div>
                    <p className="text-xl font-bold text-foreground mb-0 leading-none">
                      $
                      {(() => {

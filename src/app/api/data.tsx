...
export const portfolioData: { image: string; title: string }[] = [
  {
    ...
    title: "AI-initialized markets",
  },
  {
    image: "/images/portfolio/portfolio-icon-2.svg",
    title: "Transparent on-chain liquidity",
  },
  {
...
export const upgradeData: { title: string }[] = [
  { title: "Clean dark-mode market layouts" },
  { title: "AI and market odds side by side" },
  { title: "Mobile-ready, hackathon-focused UI" },
  { title: "Instant feedback from AI analysis" },
  { title: "Built on Algorand primitives" },
  { title: "Custodial wallet experience" },
  { title: "Clear settlement and expiry states" },
  { title: "Designed for prediction markets" },
];
...
export const perksData: {
...
}[] = [
  {
    ...
    text: "AI continuously proposes and maintains YES/NO markets from live social trends.",
    space: "lg:mt-8",
  },
  {
    icon: "/images/perks/peak-icon-2.svg",
    title: "AI probability engine",
    text: "Compare AlgoCast AI probabilities with live market odds to spot mispricing.",
    space: "lg:mt-14",
  },
  {
    icon: "/images/perks/peak-icon-3.svg",
    title: "On-chain settlement",
    text: "Prediction markets settle on Algorand for transparent, verifiable outcomes.",
    space: "lg:mt-4",
  },
];
